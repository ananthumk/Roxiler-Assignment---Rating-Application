...
const { addUser, dashboard, getStores, addStore, getUsers, getUser, allUsers } = require('../controllers/admin.controller')
...
adminRouter.get('/allusers',authenticate, authorize(['admin']), allUsers)
