...
import { X, User, Mail, Lock, MapPin, UserCog, CheckCircle } from 'lucide-react';
import React, { useState, useContext } from 'react';
import { AppContext } from '../context/storeContext';

const PostUser = ({ onClose, onSuccess }) => {
    ...
    <div className="p-8 ">
      ...
      {successMsg && (
        <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-md">
            ...
            <p className="text-sm text-center font-medium text-green-800">{successMsg}</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full p-2 border-2 border-gray-200 rounded-xll text-md bg-gray-50/50 hover:bg-white"
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full p-2 border-2 border-gray-200 rounded-md
             text-md bg-gray-50/50 hover:bg-white"
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full p-2 border-2 border-gray-200 rounded-md  text-md bg-gray-50/50 hover:bg-white"
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full p-2 border-2
             border-gray-200 rounded-md text-md bg-white hover:bg-gray-50"
            required
          >
